...
//       std::transform(uholder.begin(), uholder.end(), uholder.begin(),
//                      ::toupper);

//       if (uholder == "VAR")
//         output.push_back({"VarKeyword", holder});
//       else if (uholder == "AS")
//         output.push_back({"AsKeyword", holder});
//       else if (uholder == "IF")
...
//         output.push_back({"WhileKeyword", holder});
//       else if (uholder == "DO")
//         output.push_back({"DoKeyword", holder});
//       else if (uholder == "END")
//         output.push_back({"EndKeyword", holder});
//       else if (uholder == "RETURN")
//         output.push_back({"ReturnKeyword", holder});
//       else if (uholder == "INTEGER" || uholder == "FLOAT" ||
//                uholder == "BOOLEAN" || uholder == "STRING")
...
//       else if (uholder == "PRINT")
//         output.push_back({"PrintKeyword", uholder});
//       else
...
//         ++i;
//         if (i < input.size())
//           holder.push_back(input[i++]); // the character
...
//           switch (c) {
//           case '(':
//             output.push_back({"LParen", "("});
//             break;
//           case ')':
//             output.push_back({"RParen", ")"});
//             break;
//           case '+':
...
//             break;
//           case '/':
//             output.push_back({"Divide", "/"});
//             break;
//           case '=':
//             output.push_back({"Assign", "="});
//             break;
//           case '>':
//             output.push_back({"GreaterThan", ">"});
//             break;
//           case '<':
//             output.push_back({"LessThan", "<"});
//             break;
//           case ';':
//             output.push_back({"Semicolon", ";"});
//             break;
//           default:
//             holder.push_back(c);
//             break; // Unknown / custom
//           }
//         }
//       }
//     }
...
// //     END;"); for (auto &tok : tokens) std::cout << tok[0] << " : " <<
// tok[1]
// //     << "\n";
// // }

std::vector<std::vector<std::string>> Lexer::lexer(const std::string input) {
  std::vector<std::vector<std::string>> output;
  std::string holder;
